...
class FGPLClient(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(FGPLClient, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'fgpl_worker':
        worker_builder = {'client': FGPLClient, 'server': FGPLServer}
